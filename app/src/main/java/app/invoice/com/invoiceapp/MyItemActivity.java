    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_support:
                break;
            case R.id.nav_est:
                Intent sender = new Intent(MyItemActivity.this, EstimateActvity.class);
            ...
            case R.id.nav_settings:
                Intent senderSetting = new Intent(MyItemActivity.this, EstimateActvity.class);
        ...
        Toast.makeText(MyItemActivity.this, "position :: " + id, Toast.LENGTH_SHORT).show();
        drawer.closeDrawer(GravityCompat.START);
        return true;
    }
}
