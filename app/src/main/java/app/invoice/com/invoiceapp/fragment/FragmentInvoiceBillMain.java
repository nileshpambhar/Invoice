 ...
 */
public class FragmentInvoiceBillMain extends Fragment {
    ...
    class SectionPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0) {
                return new FragmentInvoiceBillEdit();
            } else if (position == 1) {
                return new FragmentInvoiceBillPreview();
            } else {
                return new FragmentInvoiceBillHistory();
            }
